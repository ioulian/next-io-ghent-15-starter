 ...
 */
const NextLinkButton: FC<WithRequired<Omit<LBProps<typeof Link>, "as">, "children">> = (props) => {
  ...
  return <LinkButton as={Link} prefetch={prefetch ? null : false} onMouseEnter={onMouseEnter} {...props} />;
};
